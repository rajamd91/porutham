...
import 'package:poruththam_app/features/shop/controllers/products/variation_controller.dart';
...
class CartController extends GetxController {
  ...
  void addToCart(ProductModel product) {
    ...
    /// Check if already added in tne cart
    int index = cartItems.indexWhere((cartItem) =>
        cartItem.productId == selectedCartItem.productId &&
        cartItem.variationId == selectedCartItem.variationId);

    if (index >= 0) {
      /// This quantity is already added or updated/removed from the  assign cart
  ...
  CartItemModel convertToCartItem(ProductModel product, int quantity) {
    ...
    final price = isVariation
        ? variation.salesPrice > 0.0
            ? variation.salesPrice
            : variation.price
        : product.salesPrice > 0.0
            ? product.salesPrice
            : product.price;
